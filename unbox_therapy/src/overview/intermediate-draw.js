...
const drawIntermediateLayerAnnotation = (arg) => {
  ...
  if (isFirstConv) {
    ...
    sliderX2 = leftX;
    sliderY2 = nodeCoordinate[curLayerIndex - 1][0].y + nodeLength +
      kernelRectLength * 3;
    arrowSX2 = leftX - kernelRectLength * 3;
    arrowSY2 = nodeCoordinate[curLayerIndex - 1][0].y + nodeLength + 15;
    arrowTX2 = leftX - 13;
    arrowTY2 =  nodeCoordinate[curLayerIndex - 1][0].y + 20;
    dr2 = 35;
  } else {
  ...
  drawArrow({
    group: group,
    tx: leftX - 7,
    ty: nodeCoordinate[curLayerIndex - 1][0].y + nodeLength / 2 - 5,
    sx: arrowSX,
    sy: arrowSY,
    hFlip: isFirstConv,
    dr: dr,
...
export const drawConv1 = (curLayerIndex, d, i, width, height,
  ...
  drawIntermediateLayerLegend({
    ...
    group: intermediateLayer,
    width: 2 * nodeLength + intermediateGap,
    x: nodeCoordinate[curLayerIndex - 1][0].x,
    y: svgPaddings.top + vSpaceAroundGap * (10) + vSpaceAroundGap + 
      nodeLength * 10
  });
...
export const drawConv3 = (curLayerIndex, d, i, width, height,
  ...
  let leftX = targetX - (1 * nodeLength +
    2 * hSpaceAroundGap * gapRatio + plusSymbolRadius * 1);
  let intermediateGap = (hSpaceAroundGap * gapRatio * 2) / 3;
  ...
  let leftGap = (leftEnd - nodeCoordinate[0][0].x - 2 * nodeLength) / 5;
