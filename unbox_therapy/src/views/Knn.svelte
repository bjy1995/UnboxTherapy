...
<article id="knnarticle">
  ...
  <div class="l--body">
    <h2>KNN算法的可视化</h2>
    <p>
      将鸢尾花数据根据花萼长度及花瓣长度绘制在坐标轴中，其中每一点都代表一个已知的样本，且图像中两点之间的距离便代表了它们之间的相似度。
    </p>
    <p>
      当有一个未知品种的鸢尾花时，根据它的两个特征将之绘制在图中，便可以找到它的K个最近邻。
    </p>
    <div class="hide-controls" />
  </div>
  ...
  <div class="l--body">
    <h2>尝试一下</h2>
    <p>
      你根据要求绘制好了可视化图像，并将未知品种的鸢尾花以黄点标注在了图中。
    </p>
    <p>
      拖动黄点试试吧，右上角会显示此时样本的预测类别，以及距离最近的K个样本的种类数目。
    </p>
  </div>
</article>
...
<div id="knn">
  <div id="top-legends" class="clearfix">
    <div style="float: left; margin-right: 5px;">
      ...
      <span
        id="num-k"
        style="float: left; margin-right: 5px; font-size: 25px" />
    </div>
  ...
  <div id="knn-graph">
    ...
    <div class="box" style="position: relative;">
      <slot>
        <p style="font-size: 25px; font-style: italic; fill: gray;">
          {testlabel}
        </p>
        {#each labels as label, i}
          <p style="font-style: italic;fill: gray;">
            {label} : {counts[label]}
          </p>
        {/each}
      </slot>
