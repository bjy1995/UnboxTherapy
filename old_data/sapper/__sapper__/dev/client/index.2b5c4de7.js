import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, a as space, t as text, c as claim_element, b as children, f as detach_dev, g as claim_space, h as claim_text, j as attr_dev, k as add_location, l as insert_dev, m as append_dev, n as noop } from './client.8a82743c.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span0, file, 7, 8, 194);
			attr_dev(a0, "class", "anchor");
			attr_dev(a0, "href", "#神经网络概论");
			attr_dev(a0, "aria-hidden", "");
			add_location(a0, file, 8, 8, 251);
			attr_dev(h2, "class", "svelte-a3bmb2");
			add_location(h2, file, 6, 6, 158);
			attr_dev(span1, "class", "offset-anchor");
			attr_dev(span1, "id", "构建神经网络");
			add_location(span1, file, 12, 8, 352);
			attr_dev(a1, "class", "anchor");
			attr_dev(a1, "href", "#构建神经网络");
			attr_dev(a1, "aria-hidden", "");
			add_location(a1, file, 13, 8, 409);
			add_location(h30, file, 11, 6, 338);
			add_location(p0, file, 17, 8, 521);
			add_location(p1, file, 21, 8, 643);
			add_location(blockquote, file, 16, 6, 499);
			attr_dev(span2, "class", "offset-anchor");
			attr_dev(span2, "id", "训练神经网络");
			add_location(span2, file, 24, 8, 708);
			attr_dev(a2, "class", "anchor");
			attr_dev(a2, "href", "#训练神经网络");
			attr_dev(a2, "aria-hidden", "");
			add_location(a2, file, 25, 8, 765);
			add_location(h31, file, 23, 6, 694);
			add_location(p2, file, 28, 6, 858);
			add_location(li0, file, 32, 8, 945);
			add_location(code0, file, 35, 10, 1016);
			add_location(li1, file, 33, 8, 979);
			add_location(ul0, file, 31, 6, 931);
			add_location(p3, file, 39, 6, 1149);
			add_location(p4, file, 43, 6, 1281);
			attr_dev(span3, "class", "offset-anchor");
			attr_dev(span3, "id", "最小化损失");
			add_location(span3, file, 50, 8, 1457);
			attr_dev(a3, "class", "anchor");
			attr_dev(a3, "href", "#最小化损失");
			attr_dev(a3, "aria-hidden", "true");
			add_location(a3, file, 51, 8, 1513);
			add_location(h32, file, 49, 6, 1443);
			add_location(em0, file, 56, 8, 1666);
			add_location(p5, file, 54, 6, 1608);
			add_location(b0, file, 61, 8, 1812);
			add_location(b1, file, 63, 8, 1845);
			add_location(b2, file, 65, 8, 1878);
			add_location(p6, file, 58, 6, 1706);
			attr_dev(span4, "class", "offset-anchor");
			attr_dev(span4, "id", "计算损失函数");
			add_location(span4, file, 69, 8, 1946);
			attr_dev(a4, "class", "anchor");
			attr_dev(a4, "href", "#计算损失函数");
			attr_dev(a4, "aria-hidden", "true");
			add_location(a4, file, 70, 8, 2003);
			add_location(h33, file, 68, 6, 1932);
			add_location(p7, file, 73, 6, 2105);
			add_location(li2, file, 78, 8, 2205);
			add_location(li3, file, 81, 8, 2292);
			add_location(em1, file, 87, 10, 2410);
			add_location(code1, file, 89, 10, 2464);
			add_location(em2, file, 91, 10, 2516);
			add_location(li4, file, 85, 8, 2378);
			add_location(code2, file, 98, 10, 2696);
			add_location(code3, file, 100, 10, 2752);
			add_location(li5, file, 96, 8, 2661);
			add_location(ul1, file, 77, 6, 2191);
			attr_dev(span5, "class", "offset-anchor");
			attr_dev(span5, "id", "入门");
			add_location(span5, file, 107, 8, 2926);
			attr_dev(a5, "class", "anchor");
			attr_dev(a5, "href", "#入门");
			attr_dev(a5, "aria-hidden", "");
			add_location(a5, file, 108, 8, 2979);
			add_location(h34, file, 106, 6, 2912);
			add_location(p8, file, 111, 6, 3063);
			add_location(code4, file, 114, 10, 3165);
			attr_dev(pre, "class", "language-bash");
			add_location(pre, file, 113, 8, 3126);
			attr_dev(div0, "class", "");
			add_location(div0, file, 112, 6, 3105);
			attr_dev(section, "class", "svelte-a3bmb2");
			attr_dev(section, "data-id", "神经网络概论");
			add_location(section, file, 5, 4, 102);
			attr_dev(div1, "class", "content listify svelte-a3bmb2");
			add_location(div1, file, 4, 2, 53);
			attr_dev(a6, "href", "#神经网络概论");
			attr_dev(a6, "class", "svelte-mm3tjv section");
			add_location(a6, file, 126, 10, 3478);
			attr_dev(a7, "href", "#构建神经网络");
			attr_dev(a7, "class", "svelte-mm3tjv subsection");
			attr_dev(a7, "data-level", "3");
			add_location(a7, file, 127, 10, 3548);
			attr_dev(a8, "href", "#训练神经网络");
			attr_dev(a8, "class", "svelte-mm3tjv subsection");
			attr_dev(a8, "data-level", "3");
			add_location(a8, file, 133, 10, 3701);
			attr_dev(a9, "href", "#最小化损失");
			attr_dev(a9, "class", "svelte-mm3tjv subsection");
			attr_dev(a9, "data-level", "3");
			add_location(a9, file, 139, 10, 3854);
			attr_dev(a10, "href", "#计算损失函数");
			attr_dev(a10, "class", "svelte-mm3tjv subsection");
			attr_dev(a10, "data-level", "3");
			add_location(a10, file, 145, 10, 4006);
			attr_dev(a11, "href", "#入门");
			attr_dev(a11, "class", "svelte-mm3tjv subsection");
			attr_dev(a11, "data-level", "3");
			add_location(a11, file, 151, 10, 4159);
			attr_dev(li6, "class", "svelte-mm3tjv");
			add_location(li6, file, 125, 8, 3440);
			attr_dev(a12, "href", "#神经网络概论");
			attr_dev(a12, "class", "svelte-mm3tjv section");
			add_location(a12, file, 156, 10, 4316);
			attr_dev(a13, "href", "#构建神经网络");
			attr_dev(a13, "class", "svelte-mm3tjv subsection");
			attr_dev(a13, "data-level", "3");
			add_location(a13, file, 157, 10, 4386);
			attr_dev(a14, "href", "#训练神经网络");
			attr_dev(a14, "class", "svelte-mm3tjv subsection");
			attr_dev(a14, "data-level", "3");
			add_location(a14, file, 163, 10, 4539);
			attr_dev(a15, "href", "#最小化损失");
			attr_dev(a15, "class", "svelte-mm3tjv subsection");
			attr_dev(a15, "data-level", "3");
			add_location(a15, file, 169, 10, 4692);
			attr_dev(a16, "href", "#计算损失函数");
			attr_dev(a16, "class", "svelte-mm3tjv subsection");
			attr_dev(a16, "data-level", "3");
			add_location(a16, file, 175, 10, 4844);
			attr_dev(a17, "href", "#入门");
			attr_dev(a17, "class", "svelte-mm3tjv subsection");
			attr_dev(a17, "data-level", "3");
			add_location(a17, file, 181, 10, 4997);
			attr_dev(li7, "class", "svelte-mm3tjv");
			add_location(li7, file, 155, 8, 4278);
			attr_dev(ul2, "class", "svelte-mm3tjv reference-toc");
			add_location(ul2, file, 124, 6, 3390);
			attr_dev(div2, "class", "svelte-a3bmb2 sidebar");
			add_location(div2, file, 123, 4, 3347);
			attr_dev(aside, "class", "sidebar-container svelte-a3bmb2 ");
			add_location(aside, file, 122, 2, 3293);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
